...
// TODO: EASY: Write a function that would allow you to do this:
...
// TODO: MEDIUM: Write a function that would allow you to do this:
...
function sharePizza(x) {
  let share = pizzaSlices / x;
  console.log(`Each Person gets ${share} slices of pizza`)
};

sharePizza(8);

// TODO: HARD: Data security exercise. Inside of a closure, create an object called pii (Personally Identifiable
...
class person {
  #social;
  pii(){
    this.name = 'Justin Stokes',
    this.#social = 123-12-1234
  }
};
...
// TODO: VERY HARD: Object prototype chain and prototypal inheritance exercise.
